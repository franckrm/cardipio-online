...
cardapio.metodos = {
    ...
    //atualiza o badge de totais dos botões do "Meu carrinhos"
    atualizarBadgeTotal: ()=>{
        var total = 0;
    ...
    //alterar os textos e exiber os botões das etapas
    carregarEtapa: (etapa)=>{
    ...
    resumoPedido: () =>{
        ...
        if(uf == "-1"){
            cardapio.metodos.mensagem('Informe o a UF, por favor.');
            $("#ddlUf").focus();
            return;
        }
